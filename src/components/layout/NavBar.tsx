...
export function NavBar ({ onLogoClick }: NavBarProps) {
    return (
        <div className="bg-brand-bg shadow-sm border-b border-brand-purple/20 px-6 py-4 sticky top-0 z-10">
            <div className="max-w-6xl mx-auto flex items-center justify-between">
                ...
                <div className="text-sm text-gray-600">
                    ...
                    <span className="font-semibold text-brand-orange">AI Insights</span>
                </div>
            </div>
        </div>
    )
